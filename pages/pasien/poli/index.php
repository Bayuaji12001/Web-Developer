    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-4">
          <!-- Registrarion poli -->
          <div class="card">
            <h5 class="card-header" style="background-color: #11B69F;" >Daftar Poli</h5>
            <div class="card-body">
              ...
              <form action="" method="POST">
                ...
                <button type="submit" name="submit" class="btn" style="background-color: #11B69F;">Daftar</button>
              </form>
        ...
        <div class="col-8">
          ...
          <div class="card">
            <h5 class="card-header " style="background-color: #11B69F;" >Riwayat daftar poli</h5>
            <div class="card-body">
...
<script>
  ...
  function loadJadwal(poliId) {
    ...
    xhr.open('GET', 'http://localhost/poliklinik/pages/pasien/poli/get_jadwal.php?poli_id=' + poliId, true);
